...
// timeVariationSpeedX: 'коррекция скорости (если рядом другой корабль)' 0-stop,
// timeVariationSpeedY: коррекция скорости (если рядом другой корабль)', 0-stop,
...
warShipProto[0] = {
  ...
  speedX: 0,
  speedY: 0,
  timeVariationSpeedX: 1,
  timeVariationSpeedY: 1,
  speedIndivid: 1,
  vectorLeft: true,
  rangeFactor: 1,
};
